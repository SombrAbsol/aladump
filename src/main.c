...
/*
 * Worst-case slack for the separators and suffix.
 */
#define BLOB_PATH_BUF (PATH_BUF + 32)
 ...
 */
static char g_mkdir_cache[MKDIR_CACHE_SIZE][BLOB_PATH_BUF];
